...
export default function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Super-admins go straight to the admin dashboard; everyone else to their profile.
      const me = await fetch('/api/fellows/me').then((r) => r.ok ? r.json() : null).catch(() => null)
      router.push(me?.is_super_admin ? '/admin/dashboard' : '/portal/me')
    } catch (err) {
