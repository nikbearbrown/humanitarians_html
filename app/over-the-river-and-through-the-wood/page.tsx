        ...
        <div className="mb-12">
          <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-8">
            <iframe
              ...
              src="https://www.youtube.com/embed/VAfooxj1sbc?si=ZXtisZhvLLHRVgKo&enablejsapi=1"
          ...
          <section>
            ...
            <div className="prose prose-lg dark:prose-invert">
              ...
              <div className="mt-6 flex flex-col md:flex-row gap-4 items-start">
                ...
                <a href="mailto:hr@humanitarians.ai" className="flex items-center gap-2 text-primary hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
