...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    for (const post of posts) {
      ...
      await sql`INSERT INTO blog_posts (title, subtitle, slug, content, excerpt, published, published_at, tags) VALUES (${post.title}, ${post.subtitle || null}, ${post.slug}, ${post.content}, ${post.excerpt || null}, false, ${post.publishedAt}, ${tags})`
      imported++
    }
