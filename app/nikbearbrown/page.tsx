...
export const metadata: Metadata = {
  title: "Nik Bear Brown - Humanitarians AI",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Launch your career with essential AI communication skills. Our specialized program helps recent graduates transform Nik Bear Brown into a competitive advantage in today's rapidly evolving job market.
          </p>
        ...
        <div className="grid gap-12">
          <section>
            ...
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                Companies are already hiring based not just on your traditional skills but how effectively those skills complement AI systems. Nik Bear Brown prepares you to:
              </p>
              ...
              <p className="mt-4">
                Nik Bear Brown lessons are delivered through our comprehensive YouTube series, with all lessons available for free under the Botspeak playlist. Special mentorship opportunities and peer collaboration sessions are also available for recent graduates.
              </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              All Nik Bear Brown lessons are freely available on our YouTube channel under the Botspeak playlist. Subscribe to access the complete curriculum at your own pace.
            </p>
            <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-8">
              <iframe 
                className="absolute top-0 left-0 w-full h-full"
