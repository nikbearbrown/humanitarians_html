...
export const metadata: Metadata = {
  title: "AI Literacy : How to Speak Bot - Humanitarians AI",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Launch your career with essential AI communication skills. Our specialized program helps recent graduates transform AI Literacy : How to Speak Bot into a competitive advantage in today's rapidly evolving job market.
          </p>
        ...
        <div className="grid gap-12">
          <section>
            <h2 className="text-3xl font-bold mb-6">About AI Literacy : How to Speak Bot</h2>
            <div className="prose prose-lg dark:prose-invert">
              <p>
                AI Literacy : How to Speak Bot adapts the comprehensive Botspeak framework specifically for recent graduates entering a job market where AI Literacy : How to Speak Bot is increasingly valued. Our program bridges the gap between academic knowledge and practical workplace applications, giving you the competitive edge in roles that require effective human-AI collaboration.
              </p>
              ...
              <p>
                Companies are already hiring based not just on your traditional skills but how effectively those skills complement AI systems. AI Literacy : How to Speak Bot prepares you to:
              </p>
              ...
              <p className="mt-4">
                AI Literacy : How to Speak Bot lessons are delivered through our comprehensive YouTube series, with all lessons available for free under the Botspeak playlist. Special mentorship opportunities and peer collaboration sessions are also available for recent graduates.
              </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              All AI Literacy : How to Speak Bot lessons are freely available on our YouTube channel under the Botspeak playlist. Subscribe to access the complete curriculum at your own pace.
            </p>
            <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-8">
              <iframe 
                className="absolute top-0 left-0 w-full h-full"
