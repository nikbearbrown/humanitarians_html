      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_1_Introduction.md" className="text-primary hover:underline">
                  1. Introduction
                </Link>
              </h3>
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_2_The_Magical_World_of_Wordsville.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_3_Prompt_Engineering.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_4_Persona_Pattern.md" className="text-primary hover:underline">
                  4. Persona Pattern
                </Link>
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_5_Audience_Persona_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_6_Flipped_Interaction_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_7_Game_Play_Pattern.md" className="text-primary hover:underline">
                  7. Game Play Pattern
                </Link>
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_8_Template_Pattern.md" className="text-primary hover:underline">
                  8. Template Pattern
                </Link>
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_9_Meta_Language_Creation_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_10_Recipe_Pattern.md" className="text-primary hover:underline">
                  10. Recipe Pattern
                </Link>
              </h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_11_Alternative_Approaches_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_12_Ask_for_Input_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_13_Outline_Expansion_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_14_Menu_Actions_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_15_Fact_Check_List_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_16_Tail_Generation_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_17_Semantic_Filter_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_18_Helpful_Assistant_Pattern.md" className="text-primary hover:underline">
            ...
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <h3 className="text-xl font-bold mb-2">
                <Link href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_19_RealWorld_Implementations.md" className="text-primary hover:underline">
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-wrap">
            ...
            <PrimaryButton href="https://www.humanitarians.ai/How_to_Speak_Bot_Chapter_1_Introduction.md">
              Begin Reading
            </PrimaryButton>
