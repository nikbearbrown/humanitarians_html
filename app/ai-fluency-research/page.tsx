...
export const metadata: Metadata = {
  title: "AI Fluency Research - Humanitarians AI",
  description: "Accelerate your career with AI communication skills tailored for recent graduates",
}

export default function AIFluencyResearch() {
  return (
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <div className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">AI Fluency Research</h1>
        ...
        <div className="grid gap-12">
          <section>
            <h2 className="text-3xl font-bold mb-6">About AI Fluency Research</h2>
            <div className="prose prose-lg dark:prose-invert">
              <p>
                AI Fluency Research adapts the comprehensive Botspeak framework specifically for recent graduates entering a job market where AI literacy is increasingly valued. Our program bridges the gap between academic knowledge and practical workplace applications, giving you the competitive edge in roles that require effective human-AI collaboration.
              </p>
              ...
              <h3 className="text-xl font-bold mt-6 mb-3">Why Recent Graduates Need AI Fluency Research</h3>
              
              <p>
                Companies are already hiring based not just on your traditional skills but how effectively those skills complement AI systems. AI Fluency Research prepares you to:
              </p>
              ...
              <p className="mt-6">
                Our program includes specialized modules on resume enhancement, interview preparation, and workplace scenarios specifically tailored to recent graduates. You'll develop both the practical skills and the portfolio evidence to demonstrate your AI Fluency Research to potential employers.
              </p>
              
              <p className="mt-4">
                AI Fluency Research lessons are delivered through our comprehensive YouTube series, with all lessons available for free under the Botspeak playlist. Special mentorship opportunities and peer collaboration sessions are also available for recent graduates.
              </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              All AI Fluency Research lessons are freely available on our YouTube channel under the Botspeak playlist. Subscribe to access the complete curriculum at your own pace.
            </p>
            <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-8">
              <iframe 
                className="absolute top-0 left-0 w-full h-full"
