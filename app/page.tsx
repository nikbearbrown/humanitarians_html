...
export default function Home() {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="w-full py-12 md:py-24 bg-muted dark:bg-neutral-900">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="border p-8 rounded-lg bg-background dark:bg-neutral-800 dark:border-neutral-700 hover:shadow-lg transition-shadow">
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {COURSES.map((course) => (
              <div
                key={course.title}
                className="rounded-lg border bg-background dark:bg-neutral-800 p-8 shadow-sm flex flex-col"
              >
