                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm space-y-1 ml-4">
                      <li>• Regularly review the fellow's documentation on GitHub as described at: <Link href="https://github.com/Humanitariansai" className="text-primary hover:underline">GitHub Fellows Directory</Link></li>
